...
namespace Unet
{
    static std::string InvalidNetworkAddressFamily = "Invalid network address family";
    static std::string StringDoesNotRepresentValidNetworkAddress = "String does not represent a valid network address";
    static std::string NetworkAddressCouldNotBeconvertedToString = "Network address could not be converted to string";

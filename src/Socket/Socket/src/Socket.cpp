    ...
    void                Socket::connect ( AddressUniPtr addressUniPtr )
    {
        ...
        */
        ...
        if ( connectResult != 0 )
        {
            ...
            throw Exception(ExcSocketCouldNotBeConnected,true);
    ...
    void                Socket::shutdown ( int options )
    {
        ...
        */
        ...
        if ( socketShutdownResult != 0 )
        {
            ...
            throw Exception(ExcSocketCouldNotBeShutdown,true);
...
std::cout << "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"  << std::endl;
    ...
    size_t              Socket::getUnreadDataSize ( void ) const
    {
        ...
        if ( this->hasUnreadData() == false )
        {
            ...
            throw Exception(ExcSocketHasNoIncommingData);
        ...
        if ( get_unread_data_size_success == -1 )
        {
            ...
            throw Exception(ExcIncommingDataSizeCouldNotBeRetrieved,true);
    ...
    int                 Socket::allocate ( void )
    {
        ...
        if ( socketDescriptor == -1 )
        {
            ...
            throw Exception(ExcSocketCouldNotBeOpened,true);
